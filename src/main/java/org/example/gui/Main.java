...
public class Main extends Application {
    ...
    private final Player player = gameCore.getPlayer();
    ...
    // Ajustes de física para el disparo
    ...
    public void start(Stage primaryStage) {
        ...
        AnimationTimer timer = new AnimationTimer() {
            ...
            private final double TIME_STEP = 1.0 / 60.0; // Nuestra física siempre pensará que corre a 60 FPS
    ...
    private void drawTrajectory(GraphicsContext gc) {
        ...
        // the same gravity as the player
